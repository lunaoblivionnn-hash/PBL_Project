        ...
        <div class="container-fluid px-4">
            ...
            <div class="d-none d-lg-flex align-items-center gap-3">
                <div class="text-end text-white">
                    <h6 class="mb-0 fw-bold small text-nowrap"><?= htmlspecialchars($nama_lengkap) ?></h6>
        ...
        <div class="row g-0">
            <nav class="col-md-3 col-lg-2 d-none d-md-block sidebar">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="jadwal.php"><i class="bi bi-calendar2-week-fill me-3 fs-5 align-middle"></i> Jadwal & Agenda</a></li>
