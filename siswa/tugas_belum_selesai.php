...
<head>
    ...
    <style>
        ...
        .btn-go { background: #fef2f2; color: #ef4444; border: 1px solid #fca5a5; font-weight: 700; padding: 8px 20px; border-radius: 8px; transition: 0.3s; white-space: nowrap; text-decoration: none;}
